...
public class WorldGraphFrameMini extends Frame {
	private final int NODE_DIAMETER = 10;
	private final int ARROW_DIAMETER = 5;

	public WorldGraphFrameMini() {
...
//					System.err.println("WGF::"+ sourceNode.pointerWGtoWG.size() + " aristas!!!!!!");
			...
			for (mapIterator = WorldGraphLayer.map_list.listIterator(); mapIterator
				...
				if (( WorldGraphLayer.currentNode!=null)&&(sourceNode.getId() == WorldGraphLayer.currentNode.getId()))
					drawNode(g, sourceNode.wg_x, sourceNode.wg_y, false,
							Color.magenta, true);
//				else if (sourceNode.getId() == getIdNode(2))
//					drawNode(g, sourceNode.wg_x, sourceNode.wg_y, false,
//							Color.orange.brighter().brighter().brighter().brighter(), true);
//				else if (sourceNode.getId() == getIdNode(1))
//					drawNode(g, sourceNode.wg_x, sourceNode.wg_y, false,
//							Color.orange.brighter().brighter(), true);
//				else if (sourceNode.getId() == getIdNode(0))
//					drawNode(g, sourceNode.wg_x, sourceNode.wg_y, false,
//							Color.orange, false);
				else {
//					double maxQ = WorldGraphLayer.maxQ(sourceNode.getId());
//					if (maxQ > 1) maxQ =1;
