...
public class MultiScaleModelCooperativeBhs extends NslModel implements RLRatModel {
	...
	public MultiScaleModelCooperativeBhs(ElementWrapper params, IRobot robot,
			ExperimentUniverse universe) {
		super("MSCooperativeModel", (NslModule) null);
		...
		float nonFlashingReward = params.getChildFloat("nonFlashin");
