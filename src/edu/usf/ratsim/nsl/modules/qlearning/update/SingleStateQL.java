...
public class SingleStateQL extends NslModule implements PolicyDumper {
	...
	public SingleStateQL(String nslMain, NslModule nslParent, int numStates, int numActions, float discountFactor, float alpha, float initialValue) {
