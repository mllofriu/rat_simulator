...
public class CylinderNode extends ExpUniverseNode {
	 ...
	 * @param xp Cylinder center x coordinate
	 * @param yp Cylinder center y coordinate
	 * @param zp Cylinder center z coordinate
	 */
	public CylinderNode(float r, float h, Color3f color, float xp,
			float yp, float zp){
		Appearance app = new Appearance();
		app.setColoringAttributes(new ColoringAttributes (color,1));
		Primitive vol = new Cylinder(r, h, app);
