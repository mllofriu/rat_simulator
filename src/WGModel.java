...
public class WGModel extends NslModel {
	...
	// SpatialCognitionInterfaceOpenCV pepe = new
	// SpatialCognitionInterfaceOpenCV();
	...
	public WGModel(String nslName, NslModule nslParent) {
		...
		// //gridViewer = new CellsViewer(this, "activationGrid.data", 1 , new
		// Point2D.Double(50,50));
		// System.out.println("WGModel::Grid Viewer ... OK");
		//
		// wgl = (WorldGraphLayer)
		// ReflexionLoader.getReflexionModel(learningRule, "wgl");
		// System.out.println("WGModel::"+learningRule+" ... OK");
		// mot = new MotivationalSchema("mot", this);
		// System.out.println("WGModel::Motivational ... OK");

		// System.out.println("Creando el robot ... "+
		// Configuration.getString("Reflexion.Robot"));
		// gridViewer = new CellsViewer(this, "activationGrid.data",
		// DEFAULT_GRIDS_NUMBER);
		// placeViewer = new CellsViewer(this, "activationPlace.data",
		// DEFAULT_PLACES_NUMBER);
		// System.out.println("WGModel::Grid Viewer ... OK");
