...
public class CellsViewer extends NslModule {
	...
	public CellsViewer(String nslName, String filename, NslModule nslParent,
			int dim) {
		super(nslName, nslParent);
		cellsActivationNSL = new NslDinDouble1("activationNSL", this, dim);
		System.err.println("CellsViewer::creando archivo de activacion: "
				+ Utiles.getCurrentDirectoryAbsolute() + File.separatorChar
				+ filename);
	...
	public void simRun() {
		...
		// String line = robot.getGlobalCoodinate().x+ "\t"
		// +robot.getGlobalCoodinate().y;
		//
