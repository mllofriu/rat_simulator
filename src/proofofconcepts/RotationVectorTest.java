...
public class RotationVectorTest {
	...
	public static void main(String[] args) {
		...
		rot.x =  (float) (Math.sin(rVect.angle(fVect) / 2) * Math.cos(cross.angle(new Vector3f(1,0,0))));
		rot.y =  (float) (Math.sin(rVect.angle(fVect) / 2) * Math.cos(cross.angle(new Vector3f(0,1,0))));
		rot.z =  (float) (Math.sin(rVect.angle(fVect) / 2) * Math.cos(cross.angle(new Vector3f(0,0,1))));
